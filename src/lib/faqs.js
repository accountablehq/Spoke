const FAQs = [
  ...
  {
    question: 'Does Birddog use my personal phone number to text people?',
  ...
  {
    question: 'Is Birddog available as an Android/iPhone app?',
    answer: 'Birddog is a web-based program you can access from any web browser on your computer, tablet or mobile ' +
